...
namespace NguyenMinhHiep220900100project2.Controllers
{
    public class NguoiDungsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNguoiDung,TenDangNhap,MatKhauHash,VaiTro,NgayTao,NgayCapNhat")] NguoiDung nguoiDung)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNguoiDung,TenDangNhap,MatKhauHash,VaiTro,NgayTao,NgayCapNhat")] NguoiDung nguoiDung)
        {
            if (ModelState.IsValid)
            {
